...
function Footer() {
  return (
    <footer className="bg-blue-400 text-gray-900 py-12">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-900">X-404 Sr, No-45 Cluster B-4, Akruti Countrywoods, Tilekar Nagar, Kondhwa (B), Pune-411048</p>
