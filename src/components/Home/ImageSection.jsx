  ...
  return (
    <section className="flex flex-col md:flex-row items-start justify-between min-h-screen py-10 md:py-20 px-6 md:px-8">
      ...
      <div className="md:w-1/2 mt-10 md:mt-0">
        <h2 className="text-2xl md:text-6xl font-bold text-center md:text-left hover:text-blue-500">
          What We Offer
        </h2>

        <div className="mt-8 space-y-4">
          {/* Service Card: Training hospital pharmacists */}
          <div className="flex items-center space-x-4 bg-gray-100 p-4 md:p-6 rounded-lg shadow-md transition-transform duration-300 ease-in-out transform hover:scale-105">
            <img
              src={Icon1}
              alt="Training Icon"
