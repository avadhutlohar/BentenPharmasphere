    ...
    >
      <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row w-full h-full">
        ...
        <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 p-4 md:p-6 lg:p-8 xl:p-10 flex flex-col justify-center">
          {/* About Us Heading */}
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-center mb-6 md:mb-8 lg:mb-10 xl:mb-12 transition duration-300 ease-in-out hover:text-blue-600">
            About Us
          </h2>
          <div className="flex flex-col justify-between space-y-4 md:space-y-6 lg:space-y-8 xl:space-y-10">
            {/* Card 1 */}
            <div className="bg-white bg-opacity-30 backdrop-blur-lg rounded-xl shadow-lg p-6 md:p-8 lg:p-10 xl:p-12 transition duration-300 ease-in-out hover:scale-105 hover:border hover:border-blue-600">
              <h3 className="text-xl md:text-2xl lg:text-2xl xl:text-3xl font-bold mb-4 text-gray-800 transition duration-300 ease-in-out hover:text-blue-600">
                Our Vision
              </h3>
